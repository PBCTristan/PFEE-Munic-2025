...
"""
Lancer le fichier demandera : 
1. le dossier contenant les données d'entraînement (celles de donkeycar)
2. le fichier CSV à tester
"""
...
folder_path = input("Entrez le dossier contenant les données d'entraînement (ex: './NosData') : ")
